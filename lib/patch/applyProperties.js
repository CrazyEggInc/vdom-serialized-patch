...
var isHook = require('vdom-as-json/is-vhook');
var undefinedString = require('vdom-as-json/lib/undefined');
...
function applyProperties(node, props, previous) {
  for (var propName in props) {
    ...
    if (propValue === undefined || propValue === undefinedString) {
...
function patchObject(node, props, previous, propName, propValue) {
  ...
  for (var k in propValue) {
    ...
    node[propName][k] = (value === undefined || value === undefinedString) ? replacer : value
  }
}
